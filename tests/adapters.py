...
from cs336_basics import model_checkpoint
...
def run_scaled_dot_product_attention(
    ...
    """
    return model.Attention(queries=Q, keys=K, values=V, mask=mask)
...
def run_rope(
    ...
    """
    layer = model.RotaryPositionalEmbedding(theta=theta, d_k=d_k, max_seq_len=max_seq_len)
...
def run_transformer_lm(
    ...
    """
    lm = model.TransformerLM(vocab_size=vocab_size, context_length=context_length, num_layers=num_layers, d_model=d_model, 
...
def run_get_lr_cosine_schedule(
    ...
    """
    return optimizer.learning_rate_cosine_schedule(
        t = it, 
...
def run_save_checkpoint(
    ...
    """
    model_checkpoint.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    it = model_checkpoint.load_checkpoint(src, model, optimizer)
    return it
